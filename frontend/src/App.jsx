  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to gray-100 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-8">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-8 text-center">T O D O</h1>
        
        <form onSubmit={addTodo} className="flex items-center gap-4 shadow-sm border border-gray-200 p-2 rounded-lg">
          <input className="flex-1 outline-none px-3 py-2 text-gray-700 placeholder-gray-400"
          type="text" value={newTodo} 
          onChange={(e) => setNewTodo(e.target.value)} 
          placeholder="What needs to be done"
          required />
          <button type="submit" className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2" >Add Task</button>
        </form>
                  ...
                  {editingTodo === todo._id ? (
                    <div className="flex items-center gap-x-3">
                      ...
                      <div className ="flex gap-x-2" >
                        ...
                        <button className="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 cursor-pointer" onClick={()=> setEditingTodo(null)} >
                          <IoClose />
                        </button>
                      </div>
                    </div>
